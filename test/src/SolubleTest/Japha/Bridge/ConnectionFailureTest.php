...
class ConnectionFailureTest extends TestCase
{
    ...
    {
        //$this->expectException('Soluble\Japha\Bridge\Driver\Pjb62\Exception\ConnectException');
        $this->expectException('Soluble\Japha\Bridge\Exception\ConnectionException');
