...
> and PHP7. See the the [differences here](./docs/notes.md) and if required to
> the [legacy compatibility layer](https://github.com/belgattitude/soluble-japha-pjb62-compat).
